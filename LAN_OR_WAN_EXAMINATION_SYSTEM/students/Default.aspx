<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LAN_OR_WAN_EXAMINATION_SYSTEM.students.Default" %>
    ...
    <div class="container">
        <div class="card card-login mx-auto mt-5">
            <div class="text-center">
                <div class="card-header">EXAMINATION SYSTEM - STUDENTS</div>
            </div>
            <div class="card-body">
                <form runat="server" id="formlogin">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" placeholder="Enter your email" TextMode="Email" MaxLength="50"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" placeholder="Enter your password" TextMode="Password" MaxLength="16"></asp:TextBox>
                    ...
                    <br>
                    <div class="text-center">
                        <h5><a class="d-block small" href="../students/Form_ForgotPassword.aspx">Forgot Password?</a></h5>
                    </div>
                </form>
            </div>
        </div>
