<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_SetANewPassword.aspx.cs" Inherits="LAN_OR_WAN_EXAMINATION_SYSTEM.students.Form_SetANewPassword" %>
    ...
    <div class="container">
        <div class="card card-login mx-auto mt-5">
            <div class="text-center">
                <div class="card-header">SET A NEW PASSWORD - STUDENTS</div>
            </div>
            <div class="card-body">
